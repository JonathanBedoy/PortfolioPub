  ...
  let dataArr = [
    {
      ...
      websiteLink: 'https://nia.jonathanbedoy.com/',
    ...
    },
    {
      ...
      description:
        "This web app allows the user to keep tabs on their inventory, as well as intuitively generate invoices using inputted company and inventory data. Making an invoice generates a PDF file which can then be printed out. A single-page application built using React Js, and mostly styled with Bootstrap-React. Using NeDB, the user's inputted data is stored and only served once login is verified. \nTry it out!\nUsername: guest\nPassword: password ",
      websiteLink: 'https://invoice.jonathanbedoy.com/',
